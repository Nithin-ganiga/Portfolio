...
export default function SkillsSection() {
  ...
  const technologies = [
    ...
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-12 h-12" fill="currentColor">
          <path d="M13.983 11.078h2.119a.186.186 0 00.186-.185V9.006a.186.186 0 00-.186-.186h-2.119a.185.185 0 00-.185.185v1.888c0 .102.083.185.185.185m-2.954-5.43h2.118a.186.186 0 00.186-.186V3.574a.186.186 0 00-.186-.185h-2.118a.185.185 0 00-.185.185v1.888c0 .102.082.185.185.186m0 2.716h2.118a.187.187 0 00.186-.186V6.29a.186.186 0 00-.186-.185h-2.118a.185.185 0 00-.185.185v1.887c0 .102.082.185.185.186m-2.93 0h2.12a.186.186 0 00.184-.186V6.29a.185.185 0 00-.185-.185H8.1a.185.185 0 00-.185.185v1.887c0 .102.083.185.185.186m-2.964 0h2.119a.186.186 0 00.185-.186V6.29a.185.185 0 00-.185-.185H5.136a.186.186 0 00-.186.185v1.887c0 .102.084.185.186.186m5.893 2.715h2.118a.186.186 0 00.186-.185V9.006a.186.186 0 00-.186-.186h-2.118a.185.185 0 00-.185.185v1.888c0 .102.082.185.185.185m-2.93 0h2.12a.185.185 0 00.184-.185V9.006a.185.185 0 00-.184-.186h-2.12a.185.185 0 00-.184.185v1.888c0 .102.083.185.185.185m-2.964 0h2.119a.185.185 0 00.185-.185V9.006a.185.185 0 00-.184-.186h-2.12a.186.186 0 00-.186.186v1.887c0 .102.084.185.186.185m-2.92 0h2.12a.185.185 0 00.184-.185V9.006a.185.185 0 00-.184-.186h-2.12a.185.185 0 00-.184.185v1.888c0 .102.082.185.185.185M23.763 9.89c-.065-.051-.672-.51-1.954-.51-.338 0-.676.03-1.01.09-.239-1.526-.943-2.565-2.114-3.128l-.418-.234-.234.417c-.328.58-.49 1.538-.49 2.332 0 .482.088.949.258 1.337-.207.118-.64.292-1.085.292H.594c-.26 0-.479.186-.479.437 0 .018.002.036.005.054.056 1.615.4 3.15 1.026 4.458.542 1.135 1.228 2.002 2.047 2.584.883.628 2.14.949 3.734.949.666 0 1.343-.054 2.011-.16 1.25-.199 2.424-.618 3.491-1.244.966-.565 1.801-1.283 2.483-2.134 1.737-2.165 2.654-4.81 2.654-7.663 0-.063-.001-.125-.003-.187.225-.154.917-.744 1.201-1.293l.059-.114-.298-.13z"/>
        </svg>
      ), 
      color: "text-blue-400" 
    },
          ...
          {skillCategories.map((category, index) => (
            ...
            >
              <div className="flex items-center mb-6">
                <category.icon className={`${category.color} text-3xl mr-4`} />
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {technologies.map((tech, index) => (
              <motion.div
                key={tech.name}
                className={`${tech.color} cursor-pointer transition-transform duration-300`}
